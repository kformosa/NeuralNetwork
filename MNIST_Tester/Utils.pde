class Utils {
  ...
  NeuralNetwork newNeuralNetworkFromFile(String _filename) {
    NeuralNetwork nn;
    JSONObject obj = loadJSONObject("data/" + _filename);
  ...
  void saveNeuralNetworkObject(NeuralNetwork _nn, String _name) {
    ...
    saveJSONObject(output, "data/" + _name + ".json");
  }  
